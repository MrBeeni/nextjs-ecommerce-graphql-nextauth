"use client";
import { apolloClient } from "@/app/lib/client";
...
const REGISTER_AUTHOR = gql`
  mutation RegisterAuthor($input: AutherInput!) {
...
const Register: FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("data", result); // Handle the response data as needed
      router.push("/login");
      setUser({
        firstName: "",
        lastName: "",
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 py-10 min-h-screen">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <span
                  ...
                  className="font-medium text-green-500 cursor-pointer hover:underline dark:text-green-500"
                >
                  Login here
                </span>
              </p>
